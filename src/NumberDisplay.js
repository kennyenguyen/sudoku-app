export default function NumberDisplay({ selection, onSelect }) {
    ...
    return (
        <>
            <ul className="number-display-list">
                <li className="number-display" key={ 1 }>
                ...
                <li className="number-display" key={ 2 }>
                ...
                <li className="number-display" key={ 3 }>
                ...
                <li className="number-display" key={ 4 }>
                ...
                <li className="number-display" key={ 5 }>
                ...
                <li className="number-display" key={ 6 }>
                ...
                <li className="number-display" key={ 7 }>
                ...
                <li className="number-display" key={ 8 }>
                ...
                <li className="number-display" key={ 9 }>
